...
public class BookController {
    ...
    @GetMapping("/retrieve-by-genre/{genre}")
    public List<BookEntity> retrieveByBookGenre(@PathVariable String genre)
    {
        return this.bookService.getAllBookByGenre(genre);
    }

    @GetMapping("/retrieve-top-10-seller")
    public List<BookEntity> retrieveTop10Seller()
    {
        return this.bookService.getTop10Seller();
    }
    @GetMapping("/retrieve-book-by-rating/{rating}")
    public List<BookEntity> retrieveTop10Seller(@PathVariable String rating)
    {
        return this.bookService.findBooksByRating(Double.parseDouble(rating));
    }

    @PatchMapping("/updatePriceByPublisher")
    public void  updatePriceByPublisher(@RequestBody UpdateBookByPriceByPublisherRequest updateBookByPriceByPublisherRequest)
    {
        this.bookService.updatePriceByPublisher(updateBookByPriceByPublisherRequest.getDiscount(), updateBookByPriceByPublisherRequest.getPublisher());
    }
